...
bash
mvn clean test        # Проверить тесты
mvn clean compile     # Скомпилировать проект
mvn exec:java         # Запустить приложение
Или создать JAR:
...
✅ 25,898 записей обработано

✅ 15 отделов сгенерировано
...
Технологический стек: Java 8, Maven, OpenCSV, JUnit 5
