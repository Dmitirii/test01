...
## 📁 **Создайте README.md в вашем проекте:**
...
(вставьте весь текст выше)
'@ | Out-File "C:\code\Java_Kolle\README.md" -Encoding UTF8
🚀 Финальный архив теперь будет содержать:
README.md - документация проекта

src/ - исходный код с JavaDoc
